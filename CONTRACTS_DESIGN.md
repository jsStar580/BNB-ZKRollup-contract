# Design of BNB-ZKRollup Contract
...
`BNB-ZKRollup` provides some interfaces to query L1 and L2 status.
...
This function deploy proxies for upgradeable contracts in `BNB-ZKRollup`.

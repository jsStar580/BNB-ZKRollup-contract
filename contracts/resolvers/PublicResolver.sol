...
import "../ZNS.sol";
import "./profile/BNB-ZKRollupPubKeyResolver.sol";
...
ReentrancyGuardUpgradeable
{
    ...
    function BNB-ZKRollupPubKey(bytes32 node) override external view returns (bytes32 pubKeyX, bytes32 pubKeyY) {

...
/// @notice Contract is used to allow anyone to add new ERC20 tokens to BNB-ZKRollup given sufficient payment
contract AssetGovernance is ReentrancyGuard {
    ...
    /// @notice BNB-ZKRollup governance contract
    Governance public governance;

    /// @notice Token used to collect listing fee for addition of new token to BNB-ZKRollup network
    ...
    /// @notice Adds new ERC20 token to BNB-ZKRollup network.
    ...
    /// Governance functions (this contract is governed by BNB-ZKRollup governor)

    /// @notice Set new listing token and fee
    /// @notice Can be called only by BNB-ZKRollup governor

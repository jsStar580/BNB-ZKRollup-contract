...
import "./BNB-ZKRollupOwnable.sol";
...
contract Proxy is Upgradeable, UpgradeableMaster, BNB-ZKRollupOwnable {
    ...
    constructor(address target, bytes memory targetInitializationParameters) BNB-ZKRollupOwnable(msg.sender) {
        setTarget(target);

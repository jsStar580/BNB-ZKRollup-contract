...
import "./TxTypes.sol";
import "./AdditionalBNB-ZKRollup.sol";
import "./ZNSController.sol";
import "./resolvers/PublicResolver.sol";
import "./NFTFactory.sol";

/// @title BNB-ZKRollup storage contract
/// @author BNB-ZKRollup Labs
contract Storage {
    ...
    BNB-ZKRollupVerifier internal verifier;
    ...
    AdditionalBNB-ZKRollup internal additionalBNB-ZKRollup;
    ...
    /// @notice All token pairs in BNB-ZKRollup Network

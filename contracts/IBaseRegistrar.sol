...
interface IBaseRegistrar {
    ...
    function registerZNS(string calldata _name, address _owner, bytes32 BNB-ZKRollupPubKeyX, bytes32 BNB-ZKRollupPubKeyY, address _resolver) external payable returns (bytes32, uint32);
}
